To display mathematical equations correctly in Markdown with block formatting, you can use double dollar signs ($$) for block equations. Here's the adjusted version of your content:
markdownCopy
